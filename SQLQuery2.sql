...
insert into worker11 values('monika','arora',100000,'02-02-20','HR')
insert into worker11 values('niharika','verma',80000,'01-16-11','admin')
insert into worker11 values('vishal','singhal',300000,'04-02-20','HR')
insert into worker11 values('amitabh','singh',500000,'06-02-20','admin')
insert into worker11 values('vivek','bhati',500000,'08-06-11','admin')
insert into worker11 values('vipul','diwan',200000,'10-06-11','account')
insert into worker11 values('satish','kumar',75000,'11-01-20','account')
insert into worker11 values('geetika','chauhan',90000, '01-04-11','admin')
...
foreign key(Worker_Ref_id) references Worker11(Worker_id)
 ...
 insert into Bonas values(001,5000,'05-02-20')
 insert into Bonas values(002,3000,'06-06-11')
 insert into Bonas values(003,4000,'11-02-20')
 insert into Bonas values(001,4500,'06-02-20')
 insert into Bonas values(002,3500,'01-06-11')
